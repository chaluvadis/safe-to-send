...
- Check existing [issues](https://github.com/chaluvadis/safe-to-send/issues) before opening a new one.
- Use [Discussions](https://github.com/chaluvadis/safe-to-send/discussions) or open a new issue for questions.
